...
image="registry.pytorch.org/caffe2/${JOB_BASE_NAME}"
...
local_image="registry.pytorch.org/caffe2/${BUILD_ENVIRONMENT}:${DOCKER_IMAGE_TAG}"
...
cat > src/main/groovy/ossci/onnx/DockerVersion.groovy <<EOL
// This file is automatically generated
package ossci.onnx
class DockerVersion {
  static final String version = "${DOCKER_IMAGE_TAG}";
...
EOL
git add src/main/groovy/ossci/onnx/DockerVersion.groovy

git commit -m "Update Caffe2 and ONNX DockerVersion"
'''
  }
  publishers {
    git {
