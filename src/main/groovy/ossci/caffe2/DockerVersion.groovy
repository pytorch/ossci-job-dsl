...
class DockerVersion {
  static final String version = "ba2ea059770948127484702300768ffd723e5cf9";  // WARNING: if you change this to a new version number, you **MUST** also add that version number to the allDeployedVersions list below
