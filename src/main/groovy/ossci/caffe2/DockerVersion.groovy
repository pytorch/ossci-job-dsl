...
class DockerVersion {
  static final String version = "f90df8e0edcb165bace6c48e23e5c27266f76638";  // WARNING: if you change this to a new version number, you **MUST** also add that version number to the allDeployedVersions list below
