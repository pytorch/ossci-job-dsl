...
class DockerVersion {
  static final String version = "47793f0cc1b99136bdee7981477c6d0d374f2a5e";  // WARNING: if you change this to a new version number, you **MUST** also add that version number to the allDeployedVersions list below
