...
class DockerVersion {
  static final String version = "f3d89a32912f62815e4feaeed47e564e887dffd6";  // WARNING: if you change this to a new version number, you **MUST** also add that version number to the allDeployedVersions list below
