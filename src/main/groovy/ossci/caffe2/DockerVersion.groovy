...
class DockerVersion {
  static final String version = "58400dcd94fa85d438c0336b8f0de5180cfa8da3";  // WARNING: if you change this to a new version number, you **MUST** also add that version number to the allDeployedVersions list below
