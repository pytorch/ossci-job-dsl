...
class DockerVersion {
  static final String version = "39ff7a31e97a10fc7c0f45583a8d3d6bc348174e";  // WARNING: if you change this to a new version number, you **MUST** also add that version number to the allDeployedVersions list below
