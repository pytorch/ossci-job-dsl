...
class DockerVersion {
  static final String version = "f1c9c77c8e97b85a9aa45f51b157a8883ae52f2f";  // WARNING: if you change this to a new version number, you **MUST** also add that version number to the allDeployedVersions list below
