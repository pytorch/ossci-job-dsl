...
class DockerVersion {
  static final String version = "74e757e8b0cf750d2f91db6aa4c29640abce32ea";  // WARNING: if you change this to a new version number, you **MUST** also add that version number to the allDeployedVersions list below
