...
class DockerVersion {
  static final String version = "78bcecef683efc7690aeb31260db64c655b93d56";  // WARNING: if you change this to a new version number, you **MUST** also add that version number to the allDeployedVersions list below
